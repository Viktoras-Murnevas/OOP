...
//        Square[] squares = {square, square1, square2, square3}; // masyvas ir idejom papildomai; 4x masyve
        Square[] squares = {square1, square2, square3}; // masyvas ir idejom papildomai; 4x masyve
...
//        System.out.println(square);
        ...
        for (Square square : squares){ // for loop was borrowed for learning purposes
